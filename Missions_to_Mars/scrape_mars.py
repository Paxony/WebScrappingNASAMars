...
#extract the images from the hemispheres 
    ...
    #get data to the app.py
    data["newsTitle"]=news_t
    data["newsParagraph"]=news_p
    data["bigImage"]=featured_image_url
    data["weather"]=mars_weather
    data["facts"]=df_html
    data["hemisphereimage_urls"]=hemisphere_results
